...
Usage:
    ...
    python precompute.py 2016

    # Process a specific round
    python precompute.py 2016 --round 1

    # Process a specific session type
    python precompute.py 2016 --round 1 --session R

    # Skip already-processed sessions
    python precompute.py 2016 --skip-existing

    # Process multiple years
    python precompute.py 2016 2017
"""
